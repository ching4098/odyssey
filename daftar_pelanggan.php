...
<fieldset>
            ...
            <form method="POST">
                ...
                placeholder="Contoh: 090807030555" maxlength="12" size="15"
                ...
                <input class="input3" type="text" name="noTelefon" id="noTelefon" placeholder="Contoh: 0187651769"
                ...
                placeholder="Contoh: 48" size="60" required ><br>

                <label class="alamat">Alamat (JALAN)</label><br>
                <input class="input5" type="text" name="alamat2" id="alamat2"
                placeholder="Contoh: Jalan Gembira" size="60" required ><br>

                <label class="alamat">Bandar</label><br>
                <input class="input6" type="text" name="bandar" id="bandar"
                placeholder="Contoh: Georgetown" size="60" required ><br>

                <label class="poskod">Poskod</label><br>
                <input class="input7" type="text" name="poskod" id="poskod" placeholder="Contoh: 18000"
                maxlength="5" size="15"
                onkeypress='return event.charCode >= 48 && event.charCode <= 57'
                required autofocus><br>
                ...
                placeholder="Contoh: Pulau Pinang" size="30" required><br><br>
